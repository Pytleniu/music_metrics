...
def pitch_metric_names():
    pitch_metric_names = ['pitch_range', 'n_pitches_used', 'n_pitch_classes_used', 'major_scale', 'minor_scale', 'pitch_entropy', 'pitch_class_entropy', 'pitch_class_histogram', 'chroma']
    return pitch_metric_names

@pytest.fixture
def rythm_metric_names():
    rythm_metric_names = ['empty_beat_rate', 'drum_in_pattern_rate_duple', 'drum_in_pattern_rate_triple', 'drum_pattern_consistency', 'groove_consistency', 'tempo_changes', 'n_times_tempo_change', 'end_time', 'estimate_tempi', 'estimate_tempo', 'beats', 'beat_start', 'downbeats', 'n_beats', 'onsets', 'n_notes', 'time_signatures', 'n_signatures']
